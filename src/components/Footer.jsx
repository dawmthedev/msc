      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8 xl:col-span-1">
            ...
            <p className="text-gray-500 text-base">Expert HVAC solutions for California homeowners.</p>
          </div>
            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                ...
                <ul className="mt-4 space-y-4">
                  ...
                  <li><Link to="/maintenance" className="text-base text-gray-500 hover:text-gray-900">Maintenance</Link></li>
                  <li><Link to="/installation" className="text-base text-gray-500 hover:text-gray-900">Installation</Link></li>
                </ul>
              </div>
        ...
        <div className="mt-12 border-t border-gray-200 pt-8">
          <p className="text-base text-gray-400 xl:text-center">&copy; 2024 mintair.co. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
